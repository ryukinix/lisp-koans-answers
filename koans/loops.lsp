...
(define-test test-value-accumulation-forms
    (let ((loop-1
      ...
      (destructuring-bind (col count sum max min) loop-1 ;; wow! That is new! So much useful function!
...
(define-test test-destructuring-bind
    (let* ((count 0)
           (result (loop for (a b) in '((1 9) (2 8) (3 7) (4 6)) ;; INTERESTING!!! (a, b) destructuring bind
